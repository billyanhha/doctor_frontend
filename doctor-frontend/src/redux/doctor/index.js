import {
    ...
    CLEAR_DOCTOR_LOGIN_INFO, GET_DOCTOR_LOGIN_SUCCESSFUL, GET_DOCTOR_LOGIN,
    GET_APPOINTMENTS_FROM_TO, GET_APPOINTMENTS_DETAIL, GET_PATIENT_DETAIL,
    GET_PATIENT_DETAIL_SUCCESSFUL, GET_APPOINTMENTS_DETAIL_SUCCESSFUL, GET_APPOINTMENTS_FROM_TO_SUCCESSFUL,
    RESET_STATE_DETAIL,
    GET_DOCTOR_DETAIL,
...
export const changeDoctorPassword = (doctorId,curPass, newPass, confirmPass, token) => {    
    return {
